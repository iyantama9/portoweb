    ...
    <section id="projects" className="py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        {projects.map((project, index) => (
          <div
            key={index}
            className="bg-[#161B22]/70 backdrop-blur-sm border border-gray-800 rounded-lg overflow-hidden flex flex-col group transform transition-all duration-300 hover:-translate-y-1.5 hover:border-green-400/50 hover:shadow-2xl hover:shadow-green-500/10"
          >
            {project.image && (
